class Coremetrics < Formula
  ...
  on_macos do
    ...
    on_intel do
      url "https://github.com/sviatil0/coremetrics/releases/download/v0.1.0/coremetrics-v0.1.0-macos-x86_64.tar.gz"
  ...
  test do
    ...
    # SDL3 trio and that the lifecycle controls from PR #5 work.
